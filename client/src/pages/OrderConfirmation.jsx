...
import { CheckCircle2, Package, MapPin, DollarSign, ArrowRight } from "lucide-react";
      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <p className="text-sm text-yellow-700 dark:text-yellow-400 mt-2">
            El pago será realizado contra reembolso a la entrega. Asegúrate de tener el dinero disponible.
          </p>
        </motion.div>
        ...
        >
          ...
          <ul className="space-y-2 text-sm text-blue-800 dark:text-blue-300">
            ...
            <li className="flex items-start gap-2">
              ...
              <span>El transportista se pondrá en contacto para coordinar la entrega</span>
            </li>
            <li className="flex items-start gap-2">
