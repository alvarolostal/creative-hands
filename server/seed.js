...
const MONGODB_URI =
  process.env.MONGODB_URI || "mongodb://127.0.0.1:27017/creative-hands";
  ...
  return [
    {
      ...
      description:
        "Precioso collar tejido a mano con cuentas naturales. Ideal para looks boho y regalos especiales.",
      price: 29.95,
      category: "Joyería artesanal",
      stock: 12,
      images: [
        "https://images.unsplash.com/photo-1516822003754-cca485356ecb?w=1000&q=80&auto=format&fit=crop",
      ],
    ...
    },
    {
      ...
      description:
        "Vela hecha con cera de soja 100% y fragancia natural. Aporta calidez y aroma acogedor.",
      price: 14.5,
      category: "Velas y aromáticos",
      stock: 30,
      images: [
        "https://images.unsplash.com/photo-1514894781395-71a34a02b6b4?w=1000&q=80&auto=format&fit=crop",
      ],
    ...
    },
    {
      ...
      description:
        "Bufanda suave y cálida, tejida con lana reciclada. Disponible en varios colores.",
      price: 45.0,
      category: "Textiles y ropa",
      stock: 8,
      images: [
        "https://images.unsplash.com/photo-1541099649105-f69ad21f3246?w=1000&q=80&auto=format&fit=crop",
      ],
    ...
    },
    {
      ...
      description:
        "Set de tres cuencos hechos a mano con esmalte único. Aptos para uso alimentario.",
      price: 68.0,
      category: "Cerámica y arcilla",
      stock: 5,
      images: [
        "https://images.unsplash.com/photo-1519744792095-2f2205e87b6f?w=1000&q=80&auto=format&fit=crop",
      ],
    ...
    },
    {
      ...
      description:
        "Impresión limitada de una ilustración original, firmada por el autor.",
      price: 35.0,
      category: "Arte hecho a mano",
      stock: 20,
      images: [
        "https://images.unsplash.com/photo-1508919801845-fc2ae1bc3b5d?w=1000&q=80&auto=format&fit=crop",
      ],
    ...
    },
    {
      ...
      description:
        "Taza única, ideal para café o té. Acabado esmaltado y apta para lavavajillas.",
      price: 22.0,
      category: "Cerámica y arcilla",
      stock: 25,
      images: [
        "https://images.unsplash.com/photo-1498804103079-a6351b050096?w=1000&q=80&auto=format&fit=crop",
      ],
      materials: ["arcilla", "esmalte"],
      createdBy: by(),
    },
    {
      ...
      description:
        "Bolsa resistente con ilustración serigrafiada. Perfecta para compras y uso diario.",
      price: 18.0,
      category: "Textiles y ropa",
      stock: 40,
      images: [
        "https://images.unsplash.com/photo-1520975911567-0b9b4d9d3f05?w=1000&q=80&auto=format&fit=crop",
      ],
      materials: ["algodón"],
      createdBy: by(),
    },
    {
      ...
      description:
        "Decoración bohemia tejida a mano, añade calidez a cualquier habitación.",
      price: 55.0,
      category: "Arte hecho a mano",
      stock: 10,
      images: [
        "https://images.unsplash.com/photo-1504198453319-5ce911bafcde?w=1000&q=80&auto=format&fit=crop",
      ],
      materials: ["algodón"],
      createdBy: by(),
    },
    {
      ...
      description:
        "Jabón hecho a mano con aceites naturales y lavanda. Suave para la piel.",
      price: 6.5,
      category: "Velas y aromáticos",
      stock: 100,
      images: [
        "https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=1000&q=80&auto=format&fit=crop",
      ],
    ...
    },
    {
      ...
      description:
        "Cuaderno con papel de alta calidad y encuadernación artesanal.",
      price: 20.0,
      category: "Arte hecho a mano",
      stock: 60,
      images: [
        "https://images.unsplash.com/photo-1515879218367-8466d910aaa4?w=1000&q=80&auto=format&fit=crop",
      ],
    ...
    },
    {
      ...
      description:
        "Maceta pequeña con esmalte brillante, perfecta para suculentas.",
      price: 24.0,
      category: "Cerámica y arcilla",
      stock: 35,
      images: [
        "https://images.unsplash.com/photo-1592928302472-9f9d6f1a6c9d?w=1000&q=80&auto=format&fit=crop",
      ],
      materials: ["arcilla", "esmalte"],
      createdBy: by(),
    },
    ...
    },
    {
      ...
      stock: 50,
      images: [
        "https://images.unsplash.com/photo-1505691723518-36a6f8c5f6b6?w=1000&q=80&auto=format&fit=crop",
      ],
      materials: ["yute"],
      createdBy: by(),
    },
    {
      ...
      stock: 22,
      images: [
        "https://images.unsplash.com/photo-1519741492740-08f8b0e2a3b4?w=1000&q=80&auto=format&fit=crop",
      ],
    ...
    },
    {
      ...
      description:
        "Bolso pequeño ideal para llevar lo esencial, acabado artesanal.",
      price: 49.0,
      category: "Textiles y ropa",
      stock: 14,
      images: [
    ...
    },
    {
      ...
      stock: 120,
      images: [
        "https://images.unsplash.com/photo-1503602642458-232111445657?w=1000&q=80&auto=format&fit=crop",
      ],
    ...
    },
    {
      ...
      description:
        "Guirnalda decorativa con cuentas y micro-LEDs, ambiente acogedor.",
      price: 32.0,
      category: "Arte hecho a mano",
      stock: 40,
      images: [
        "https://images.unsplash.com/photo-1496307042754-b4aa456c4a2d?w=1000&q=80&auto=format&fit=crop",
      ],
